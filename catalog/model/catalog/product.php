...
//                }
	...
	public function getLatestProduct(){
		$query = $this->db->query("SELECT * FROM " . DB_PREFIX . "product p LEFT JOIN " . DB_PREFIX . "product_description pd ON (p.product_id = pd.product_id) ORDER BY `date_added` DESC LIMIT 1");
