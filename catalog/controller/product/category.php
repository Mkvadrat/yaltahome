...
class ControllerProductCategory extends Controller {  
	...
	public function index() { 
		...
		if ($category_info) {
			...
			$this->data['text_maps'] = $this->language->get('text_maps');
			...
			$this->data['top_description'] = html_entity_decode($category_info['top_description'], ENT_QUOTES, 'UTF-8');						
