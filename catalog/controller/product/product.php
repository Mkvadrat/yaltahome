...
class ControllerProductProduct extends Controller {
	...
	public function index() { 
		...
		if ($product_info) {
			...
			$agent = $this->model_catalog_product->Agent($product_info['agent']);
			
			$this->load->model('tool/image');
			
			if($agent['image']){
				$this->data['image_agent'] = $this->model_tool_image->resize($agent['image'], 145, 145);
			}else{
				$this->data['image_agent'] = '';
			}
			...
			foreach ($results as $result) {
				...
				$this->data['images'][] = array(
                    ...
                    'full' => $this->model_tool_image->resize($result['image'], 700, 400),
