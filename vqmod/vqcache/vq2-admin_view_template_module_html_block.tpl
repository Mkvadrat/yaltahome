							...
							<tbody>
								...
								<tr>
									<td style="vertical-align: top;">
										<label for="html-block-theme-<?php echo $theme_id; ?>-template"><?php echo $entry_theme; ?></label><a class="js show-default"><?php echo $text_default_template; ?></a>
									</td>
									<td>
...
function addBlock() {
	...
	html += '							</div>';
	html += '							<textarea class="enabled" rows="19" cols="130" name="html_block_' + block_id + '[content][<?php echo $language['language_id']; ?>]" id="content-' + content_row + '-<?php echo $language['language_id']; ?>"></textarea><p class="help"><?php echo $text_php_help . '.<br />' . $text_php_help_editor; ?>';
	html += '</p><input type="hidden" name="html_block_' + block_id + '[editor][<?php echo $language['language_id']; ?>]" value="1" />';
	html += '						</td>';
	html += '					</tr>';
	html += '				</tbody>';
	html += '			</table>';
...
$('a.js.show-default').live('click', function(event){
	...
	$(this).closest('tr').find('textarea').val(default_theme);
...
function addTheme() {
	...
	html += '			</tr>';
	html += '			<tr>';
	html += '				<td style="vertical-align: top;"><label for="html-block-theme-' + theme_id + '-template"><?php echo $entry_theme; ?></label><a class="js show-default"><?php echo $text_default_template; ?></a></td>';
	html += '				<td>';
	html += '					<p class="link">';
	html += '						<a class="js"><?php echo $text_tokens; ?></a>';
	html += '					</p>';
