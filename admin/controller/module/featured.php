...
class ControllerModuleFeatured extends Controller {
	...
	public function index() {   
		...
		//Текстовой блок
		if (isset($this->request->post['line_first'])) {
			$this->data['line_first'] = $this->request->post['line_first'];
		} else {
			$this->data['line_first'] = $this->config->get('line_first');
		}	
		
		if (isset($this->request->post['line_second'])) {
			$this->data['line_second'] = $this->request->post['line_second'];
		} else {
			$this->data['line_second'] = $this->config->get('line_second');
		}	
