...
<tr>
        ...
        <div id="tab-image">
          <table id="images" class="list imagemanager"">
            <thead>
              <tr>
								<td class="imagemanager-style"></td>
            ...
            <tbody id="image-row<?php echo $image_row; ?>">
              <tr class="fa-move">
								<td class="imagemanager-grab"><i class="fa fa-bars"></i></td>
...
function addImages(thumbs, link, item) {
  html  = '<tbody id="image-row' + image_row + '">';
	html += '  <tr class="fa-move">';
	html += '    <td class="imagemanager-grab"><i class="fa fa-bars"></i></td>';
	html += '    <td class="left"><div class="image"><img src="' + thumbs + '" alt="" id="thumb' + image_row + '" /><input type="hidden" name="product_image[' + image_row + '][image]" value="' + link + '" id="image' + image_row + '" /><br /><a onclick="image_upload(\'image' + image_row + '\', \'thumb' + image_row + '\');"><?php echo $text_browse; ?></a>&nbsp;&nbsp;|&nbsp;&nbsp;<a onclick="$(\'#thumb' + image_row + '\').attr(\'src\', \'<?php echo $no_image; ?>\'); $(\'#image' + image_row + '\').attr(\'value\', \'\');"><?php echo $text_clear; ?></a></div></td>';
	html += '    <td class="right"><input type="text" name="product_image[' + image_row + '][sort_order]" value="' + item + '" size="2" /></td>';
...
<script type="text/javascript"><!--
	$(document).ready(function() {
		$('.imagemanager').sortable({
			axis: 'y',
			forcePlaceholderSize: true,
			placeholder: 'group_move_placeholder',
			stop: function(event, ui)
			{	
				$('.imagemanager input[name$="[sort_order]"]').each(function(i) {
					$(this).val(i);
				});			
			}
		});	
		
		$(".imagemanager").mousedown(function() {
			$(".imagemanager-grab").addClass("imagemanager-grabbing");
		});	
		
		$(".imagemanager").mouseup(function() {
			$(".imagemanager-grab").removeClass("imagemanager-grabbing");
		});	
	});	
//--></script>
<?php echo $footer; ?>