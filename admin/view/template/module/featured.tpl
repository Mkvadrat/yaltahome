        ...
        <tr>
          ...
          <td><div id="featured-product" class="scrollbox">
            ...
            <input type="hidden" name="featured_product" value="<?php echo $featured_product; ?>" /></td>
				...
				<tr>
          <td>Текстовой блок 1</td>
          <td>
						<textarea id="editor-1" rows="10" cols="45" name="line_first"><?php echo $line_first; ?></textarea>
					</td>
        </tr>
				<tr>
          <td>Текстовой блок 2</td>
          <td>
						<textarea id="editor-2" rows="10" cols="45" name="line_second"><?php echo $line_second; ?></textarea>
					</td>
        </tr>
      </table>
